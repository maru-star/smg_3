...
class Venue extends Model
{
    ...
    public static function searchs(
        ...
        if (isset($freeword)) {
            ...
            return self::where('alliance_flag', 'LIKE', "%$alliance_flag%")->paginate(10);
        } else if (isset($name_area)) {
            return self::where('name_area', 'LIKE', "%$name_area%")->paginate(10);
        } else if (isset($name_bldg)) {
            return self::where('name_bldg', 'LIKE', "%$name_bldg%")->paginate(10);
        } else if (isset($name_venue)) {
            return self::where('name_venue', 'LIKE', "%$name_venue%")->paginate(10);
        } else if (isset($capacity1) && isset($capacity2)) {
            return self::whereBetween('capacity', $capacity1, $capacity2)->paginate(10);;
        } else if (isset($capacity1)) {
            return self::where('capacity', '>=', $capacity1)->paginate(10);;
        } else if (isset($capacity2)) {
            return self::where('capacity', '<=', $capacity2)->paginate(10);;
        } else {
